...
<body>
	...
	<div class="content active">
		<nav class="sidebar">
			<ul class="side-nav">
				...
				<li class="side-nav__item"><a href="../member" class="side-nav__link">
						<span>退出模式</span>
				</a></li>
			</ul>
		</nav>
		...
		<main class="main-table">
			...
			<section class="section-table">
				<form action="../register" method="POST" class="section-form">
		            ...
		            <div class="display-align">
		              <label for="gender" class="label-other">性別</label>
			...
			<section class="section-table">
				...
				<form action="" method="POST" class="section-form margin-bottom-10">
		            ...
		            <div class="display-flex">
		              <label for="updateUserId">編號</label>
		              <input
		                type="text"
		                class="userid"
		                id="updateUserId"
		            ...
		            <div class="btn-box">
		              <button type="button" class="form-btn" id="updateUserId-btn">查詢</button>
		            </div>
	        	</form>
	        	
	        	<!-- 準備更新的會員資料 -->
	        	<form action="../update" method="POST" class="section-form">
		            ...
		            <div class="display-align">
		              <label for="updateBirthday">出生年月日</label>
		              <input
		                type="date"
		                class="birthday"
		                id="updateBirthday"
		            ...
		            <div class="display-align">
		              <label for="updateGender" class="label-other">性別</label>
			...
			<section class="section-table">
				...
				<form action="" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="deleteUserId">編號</label>
		              <input
		                type="text"
		                class="userid"
		                id="deleteUserId"
	...
	<div class="content">
		...
		<main class="main-table">
			...
			<!-- 新增寵物 -->
			<section class="section-table">
				<form action="../add-pet" method="POST" class="section-form" enctype="multipart/form-data">
		            ...
		            <div class="display-align">
		              <span class="label-other">圖片</span>
		              <label for="image" class="lab__img">
		                <div id="formFile" class="formFile"></div>
		                <ion-icon
		                  name="images-outline"
		                  class="lab__img-icon"
		                ></ion-icon>
			...
			<section class="section-table">
				...
				<form action="" method="POST" class="section-form margin-bottom-10">
		            ...
		            <div class="display-flex">
		              <label for="updatePetId">編號</label>
		              <input
		                type="text"
		                class="petid"
		                id="updatePetId"
		            ...
		            <div class="btn-box">
		              <button type="button" class="form-btn" id="updatePetId-btn">查詢</button>
		            </div>
            	</form>
            	
            	<!-- 準備更新的寵物資料 -->
            	<form action="../update-pet" method="POST" class="section-form" enctype="multipart/form-data">
		            <h3 class="form-heading">更新寵物</h3>
		
		            <div class="display-flex">
		              <label for="updatePetName">寵物名稱</label>
		              <input
		                type="text"
		                class="petName"
		                id="updatePetName"
		            ...
		            <div class="display-flex">
		              <label for="updateBreed">品種</label>
		              <input
		                type="text"
		                class="breed"
		                id="updateBreed"
		            ...
		            <div class="display-flex">
		              <label for="updatePetGender">性別</label>
		              <input
		                type="text"
		                class="gender"
		                id="updatePetGender"
		            ...
		            <div class="display-flex">
		              <label for="updateCoatColor">毛色</label>
		              <input
		                type="text"
		                class="coatColor"
		                id="updateCoatColor"
		            ...
		            <div class="display-flex">
		              <label for="updateLocation">所在地</label>
		              <input
		                type="text"
		                class="location"
		                id="updateLocation"
		            ...
		            <div class="display-flex">
		              <label for="updateSpecies">種類</label>
		              <input
		                type="text"
		                class="species"
		                id="updateSpecies"
		            ...
		            <div class="display-align">
		              <span class="label-other">圖片</span>
		              <label for="updatePhotos" class="lab__img">
			...
			<section class="section-table">
				<form action="" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="deletePetId">編號</label>
		              <input
		                type="text"
		                class="petid"
		                id="deletePetId"
		...
		<main class="main-table">
			...
			<section class="section-table">
				<form action="../do-publish" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="publishUserId">刊登者編號</label>
		              <input
		                type="text"
		                class="userid"
		                id="publishUserId"
		            ...
		            <div class="display-flex">
		              <label for="publishPetId">要刊登的寵物</label>
		              <input
		                type="text"
		                class="petid"
		                id="publishPetId"
			...
			<section class="section-table">
				...
				<form action="" method="POST" class="section-form margin-bottom-10">
		            ...
		            <div class="display-flex">
		              <label for="updatePublishId">編號</label>
		              <input
		                type="text"
		                class="publishid"
		                id="updatePublishId"
		            ...
		            <div class="btn-box">
		              <button type="button" class="form-btn" id="updatePublishId-btn">查詢</button>
		            </div>
            	</form>
            	...
            	<form action="../do-publish" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="updatePublishUserId">刊登者編號</label>
		              <input
		                type="text"
		                class="userid"
		                id="updatePublishUserId"
		                name="userid"
		                placeholder="使用者編號"
		              />
		            </div>
		            ...
		            <div class="display-flex">
		              <label for="updatePublishPetId">要刊登的寵物</label>
		              <input
		                type="text"
		                class="petid"
		                id="updatePublishPetId"
		                name="petid"
		                placeholder="寵物編號"
		              />
		            </div>
			...
			<section class="section-table">
				<form action="" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="deletePublishId">編號</label>
		              <input
		                type="text"
		                class="publishid"
		                id="deletePublishId"
		...
		<main class="main-table">
			...
			<section class="section-table">
				<form action="../do-adoption" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="adoptionUserId">預約者編號</label>
		              <input
		                type="text"
		                class="userid"
		                id="adoptionUserId"
		            ...
		            <div class="display-flex">
		              <label for="adoptionPetId">要預約的寵物</label>
		              <input
		                type="text"
		                class="petid"
		                id="adoptionPetId"
			...
			<section class="section-table">
				...
				<form action="" method="POST" class="section-form margin-bottom-10">
		            ...
		            <div class="display-flex">
		              <label for="updateAdoptionId">編號</label>
		              <input
		                type="text"
		                class="adoptionid"
		                id="updateAdoptionId"
		            ...
		            <div class="btn-box">
		              <button type="button" class="form-btn" id="updateAdoptionId-btn">查詢</button>
		            </div>
            	</form>
            	
            	<!-- 準備更新的預約資料 -->
            	<form action="../update-adoption" method="POST" class="section-form">
		            <h3 class="form-heading">更新預約</h3>
		            
		            <div class="display-flex">
		              <label for="updateAdoptionResult">預約結果</label>
		              <input
		                type="text"
		                class="adoptionResult"
		                id="updateAdoptionResult"
		                name="adoptionResult"
		                placeholder="同意 or 不同意"
		              />
		            </div>
			...
			<section class="section-table">
				<form action="" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="deleteAdoptionId">編號</label>
		              <input
		                type="text"
		                class="adoptionid"
		                id="deleteAdoptionId"
		...
		<main class="main-table">
			...
			<section class="section-table">
				<form action="../do-permiss" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="roleUserId">使用者編號</label>
		              <input
		                type="text"
		                class="userid"
		                id="roleUserId"
			...
			<section class="section-table">
				...
				<form action="" method="POST" class="section-form margin-bottom-10">
		            ...
		            <div class="display-flex">
		              <label for="updatePermissUserId">會員編號</label>
		              <input
		                type="text"
		                class="permissionsUserid"
		                id="updatePermissUserId"
		            ...
		            <div class="btn-box">
		              <button type="button" class="form-btn" id="updatePermissUserId-btn">查詢</button>
		            </div>
            	</form>
            	
            	<!-- 準備更新的權限資料 -->
            	<form action="../do-update-permiss" method="POST" class="section-form">
		            <h3 class="form-heading">更新權限</h3>
		            
		            <div class="display-flex">
		              <label for="updateRole">權限</label>
		              <input
		                type="text"
		                class="role"
		                id="updateRole"
			...
			<section class="section-table">
				<form action="" method="POST" class="section-form">
		            ...
		            <div class="display-flex">
		              <label for="deletePermissUserId">編號</label>
		              <input
		                type="text"
		                class="permissionsid"
		                id="deletePermissUserId"
		                name="permissionsid"
		                placeholder="輸入權限編號"
		              />
		            </div>
